    ...
    >
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        <div className="text-center space-y-8">
          ...
          <motion.div
            ...
            className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-200 shadow-sm"
          >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-bold text-gray-900 font-poppins leading-tight"
          >
            Creo{" "}
          ...
          >
            <a
              href="#contatti"
              className="group bg-gradient-primary text-white px-8 py-4 rounded-full font-medium text-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex items-center space-x-2"
            >
            ...
            <a
              href="#portfolio"
              className="px-8 py-4 rounded-full font-medium text-lg border-2 border-gray-300 hover:border-primary hover:text-primary transition-all duration-300 flex items-center space-x-2"
            >
      ...
      >
        <a href="#chi-sono" className="flex flex-col items-center animate-bounce">
          ...
          <span className="text-xs text-gray-500 mt-2">Scorri</span>
        </a>
      </motion.div>
    </section>
  );
